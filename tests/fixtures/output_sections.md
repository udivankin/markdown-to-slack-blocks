...
This is a paragraph with text styles: **bold**, *italic*, ~strike~, `code`. And with non-formatted mentions: @jdoe, <!here>, @devs, #general. And with formatted mentions: @jdoe, #general, @devs, <@here>, @T123456.
